    ...
    <section className="service-section">
      ...
      <div className="service-columns">
        <div className="service-column" >
          ...
          <p className="service-content" style={{ fontFamily: 'Poppins', fontSize: '36px', fontWeight: 'bold' }}>Custom Tailoring</p>
        ...
        <div className="service-column">
          ...
          <p className="service-content" style={{ fontFamily: 'Poppins', fontSize: '36px', fontWeight: 'bold' }}>Personal Shopper</p>
          <p className="service-content2" style={{ fontFamily: 'Poppins', fontSize: '20px', fontWeight: 'bold' }}>Style with Ease</p>
        </div>
      </div>
    </section>
  );
