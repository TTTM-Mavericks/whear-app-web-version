  ...
  return (
    <section className="follow-us-section-mobile">
      ...
      <Button
        ...
        style={{ color: 'black', borderColor: 'black', position: 'absolute', left: 0, top: '50%', transform: 'translateY(-50%)' }}
      >
        <ArrowBackIcon />
      </Button>
      ...
      <Button
        ...
        style={{ color: 'black', borderColor: 'black', position: 'absolute', right: 0, top: '50%', transform: 'translateY(-50%)' }}
      >
        <ArrowForwardIcon />
      </Button>
    </section>
