...
import EditForm from './EditNews';
import CsvDownloader from 'react-csv-downloader';
import DownloadIcon from '@mui/icons-material/Download';
import AddUserAppInstalled from './AddNews';
...
const ManageNews: React.FC = () => {
    ...
    const [data, setData] = useState<ManageNews[]>([]);
    const [row, setRows] = useState<ManageNews[]>([]);
    const [editopen, setEditOpen] = useState(false);
    const [formid, setFormId] = useState<ManageNews | null>(null);
    ...
    const fillData = (dataFilter: ManageNews | null) => {
        if (dataFilter) {
            setData([dataFilter]);
        } else {
            setData(row);
                ...
                <div style={{ display: "flex" }}>
                    ...
                    <div>
                        <Autocomplete
                            ...
                            onChange={(e, v) => { fillData(v as ManageNews) }}
                            disablePortal
                            options={data}
                            sx={{ width: 200 }}
